...
public class CronTriggerManager {
	 ...
	 */
	public void addJob(Task task, boolean isImmediateExcute) throws SchedulerException {
	 ...
	 * @throws SchedulerException
	 */
	public void delJob(Task task) throws SchedulerException{
		SchedulerFactory schedulerFactory = new StdSchedulerFactory();
		Scheduler scheduler = schedulerFactory.getScheduler();
		JobKey jobKey = JobKey(task);
	 ...
	 * @throws SchedulerException 
	 */
	private void triggerJob(Task task, Scheduler scheduler) throws SchedulerException {
		JobKey jobKey = JobKey(task);
	 ...
	 * @return
	 */
	private JobKey JobKey(Task task) {
